...
const teachers = [
  {
    ...
    role: "Maitre",
    bio: "Président du Conseil National des Maitres. Plus de 50 années de pratique, expert international. Encadre les cours adultes/ados",
  ...
  },
  {
    ...
    role: "Maitre",
    bio: "Combat, cardio, endurance,... Encadre les cours adultes/ados le lundi soir",
  ...
  },
   {
    ...
    rank: "Ceinture rouge - Noire IVᵉ Dang (système international)",
    role: "Maitre",
    bio: "Maitrise technique, combat, cardio... Encadre les cours adultes/ados",
